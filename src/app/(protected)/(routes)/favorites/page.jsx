...
import { PgButton } from '../../record-components/ui/pg-button'
import { BtnBorderIcon } from '@/components/ui/button-icons'
import ResourceQuickActions from '../../record-components/ui/resource-quick-actions'
import ResourceOverview from '../../record-components/ui/resource-overview'
import EmptyList from '../../record-components/ui/empty-list'
import ErrorFetching from '../../record-components/ui/error-fetching'
  ...
  */
  ...
  return (
    <main className='mt-7 card-container text-neutral-300'>
      ...
      {(!loading && !error && setFavRecords.length > 0) && (
